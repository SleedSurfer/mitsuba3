...
class PlateHexagon(HexagonalParticle):
    ...
    def randomize_orientations(self, num_rays: int, rng):
        ...
        # 4. CREATE A LOCAL BASIS PERPENDICULAR TO THE WOBBLING C-AXIS
